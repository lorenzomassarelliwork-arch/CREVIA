...
export default function BottomNavBar({
  ...
  const indicatorTranslation = position.interpolate({
    inputRange,
    outputRange: inputRange.map((index) => index * tabWidth),
    extrapolate: 'clamp',
  });
  ...
  return (
    <View style={styles.navBar}>
      <Animated.View
        style={[
          styles.indicator,
          { width: tabWidth, transform: [{ translateX: indicatorTranslation }] },
        ]}
      />
