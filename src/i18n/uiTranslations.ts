...
const IT_TO_EN: Record<string, string> = {
  ...
  'Scegli se creare una nuova pagina progetto o una nuova esperienza professionale.':
    'Choose whether to create a project page or add professional experience.',
  'Nuova pagina progetto': 'New project page',
  ...
  'Crea ed Entra nella Pagina': 'Create and open page',
  ...
  'Settore *': 'Field *',
  'Pagina progetto di riferimento *': 'Related project page *',
  'Nome pagina progetto': 'Project page name',
  ...
  'Elimina Pagina Progetto': 'Delete Project Page',
  'Sei sicuro di voler eliminare definitivamente questa pagina progetto?':
    'Are you sure you want to permanently delete this project page?',
